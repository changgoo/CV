...
{PhD thesis projects}
{Roman Hix (Princeton, 2025--), Minghao Guo (Princeton, 2022--2024), Woorak Choi (Yonsei, PhD in 2024),  Sanghyuk Moon (SNU, PhD in 2022),  Lachlan Lancaster (Princeton, PhD in 2022),  Alwin Mao (Princeton, PhD in 2020),  Munan Gong (Princeton, PhD in 2017)}
...
{Jake Grodner (Princeton, 2025), Taeho Kim (Princeton, 2025), Austin Guo (Princeton, 2025), Tejahni Desire (Princeton, 2024), Sajia Shahrin Neha (Princeton, 2023), Ish Kaul (Princeton, 2022),  Ryan Golant (Princeton, 2019),  Mohammad Refat (CCA/CUNY via \href{http://cunyastro.org/astrocom/}{AstroCom NYC}, 2018),  Roberta Raileanu (Princeton, 2014)}
%================================================================================

\itemtitle{Teaching}


\elements{2021 -- present}
{Bootcamp Lecturer}
...
{Referee}
{ApJ, MNRAS, JOSS, RASTI, NatA, A&A, OJAp}
\onelineelements{2023 -- present}
{Coordinator}
{Daily Astro Coffee at Princeton University}
\onelineelements{2026 -- }
{Organizer}
{Unifying Cosmic-Ray Research: Connecting Astroparticle Phenomenology with Advanced Theories, Simulations, and Observations}
\onelineelements{2024 -- present}
{Organizer}
...
\begin{itemize}[itemsep=0pt,topsep=\parskip]
\small \input{../data/pubs_arxiv.tex}
\end{itemize}
...
\itemtitle{Conference Proceedings/White Papers}
...
\onelineelements{10/2025}
{Contributed Talk}
{\emph{TIGRESS++ Simulations of Star-Forming Disks: Self-Consistent CR Feedback and Multiphase Outflows},
Korean Astronomical Society Fall Meeting,
Jeju, Korea}

\onelineelements{09/2025}
{Invited Talk}
{\emph{Bridging Galactic and Cosmological Scales: Baryonic Modeling for Next-Generation Simulations},
Simons Collaboration on Learning the Universe Annual Meeting,
New York, NY}
...
\onelineelements{07/2025}
{Contributed Talk}
{\emph{Caveats: shearing-box? or not?},
Lorentz Center workshop: Numerical Recipes in Star Formation,
Leiden, The Netherlands}

\onelineelements{06/2024}
{Invited Talk}
...
\onelineelements{03/2024}
{Seminar}
{\emph{Metallicity dependence of Galactic Star Formation Rates},
Bahcall Lunch,
Princeton, NJ}

\onelineelements{02/2024}
{Seminar}
{\emph{Metallicity Dependence of SFRs},
Star Formation/ISM Rendesvous,
Princeton, NJ}

\onelineelements{12/2023}
{Invited Talk}
{\emph{Numerical modeling of the Star-Forming ISM: TIGRESS-NCR},
2023 Salpeter Workshop,
Ithaca, NY}

\onelineelements{11/2023}
{Seminar}
